...
const Footer: FunctionalComponent = () => {
  return (
    <footer class="max-w-[1200px] 2xl:px-10 mx-auto mt-28 pt-8 pb-16 md:px-0 px-4">
      <h3 class="text-5xl text-white font-black mb-[38px] font-['Arial_Black']">Contact Us</h3>
      <ul class="text-white/80 space-y-[30px] text-base">
        <li class="flex items-center gap-[14px]">
          ...
          718 Whiteriver Ave, Rifle, CO 81650, United States
        </li>
        <li class="flex items-center gap-[14px]">
        ...
        <li class="flex items-center gap-[14px]">
          ...
          Email:  eternalenamellc@gmail.com
        </li>
      </ul>
    </footer>
  )
